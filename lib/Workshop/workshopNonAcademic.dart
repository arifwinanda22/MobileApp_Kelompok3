...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const WorkshopNonAcademicPage(),
    );
  }
}
...
class WorkshopNonAcademicPage extends StatefulWidget {
  const WorkshopNonAcademicPage({Key? key}) : super(key: key);

  @override
  State<WorkshopNonAcademicPage> createState() =>
      _WorkshopNonAcademicPageState();
}

class _WorkshopNonAcademicPageState extends State<WorkshopNonAcademicPage> {
  final List<WorkshopCard> workshops = [
    WorkshopCard(
      imageUrl: 'assets1/boxing.jpg',
      title: 'Learn Boxing for 30 Days',
    ),
    WorkshopCard(
      imageUrl: 'assets1/guitar.jpg',
      title: 'Master the Guitar in a Month',
    ),
    WorkshopCard(
      imageUrl: 'assets1/debate.jpg',
      title: 'Become a Skilled Debater in 4 Weeks',
    ),
    WorkshopCard(
      imageUrl: 'assets1/photograph.jpg',
      title: 'Photography Bootcamp: Capture Like a Pro',
    ),
    WorkshopCard(
      imageUrl: 'assets1/drawing.jpg',
      title: 'Drawing Masterclass: From Basics to Artistry',
    ),
  ];
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      ...
      case 1:
        targetPage =
            WorkshopAcademicPage(); // Default to academic workshop page
        break;
      case 2:
      ...
      case 4:
        ...
        targetPage = WorkshopNonAcademicPage();
        break;
      default:
        targetPage = SmartCompApp();
    }
        ...
        children: [
          ...
          Padding(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                // You can add navigation to workshop detail here if needed
              },
      ...
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context); // Close the drawer
              // Already on workshop page (non-academic)
            },
          ),
          ListTile(
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => WorkshopAcademicPage()),
              );
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context); // Close the drawer
              // Already on non-academic workshop page
            },
          ),
        ],
      ),
